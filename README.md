...
Open `demandx.streamlit.app`. The first training run creates a demo CSV in `data/raw/`, a SQLite database, engineered features, a model artifact, and evaluation metrics.
